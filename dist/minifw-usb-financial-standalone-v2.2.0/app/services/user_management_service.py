...
class UserManagementService:
    ...
    def update_user_role(
        self, user_id: int, new_role: UserRole, modified_by: User
    ) -> User:
    ...
    def update_user_sector(
        self, user_id: int, new_sector: SectorType, modified_by: User
    ) -> User:
    ...
    def disable_user(
        self, user_id: int, disabled_by: User, reason: Optional[str] = None
    ) -> User:
    ...
    def enable_user(self, user_id: int, enabled_by: User) -> User:
    ...
    def record_successful_login(
        self, user: User, ip_address: str, user_agent: str, session_id: str
    ):
    ...
    def reset_password(self, user_id: int, new_password: str, reset_by: User) -> str:
    ...
    def get_users_by_sector(
        self, sector: SectorType, include_inactive: bool = False
    ) -> List[User]:
    ...
    def get_users_by_role(
        self, role: UserRole, sector: Optional[SectorType] = None
    ) -> List[User]:
