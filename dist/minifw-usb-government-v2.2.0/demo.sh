#!/usr/bin/env bash
# MiniFW-AI — Government Sector Demo Launcher
# Run: bash demo.sh
...
IMAGE_TAR="${USB_DIR}/images/minifw-government.tar"
COMPOSE_FILE="${USB_DIR}/docker/docker-compose.usb-government.yml"
...
echo ""
echo "  ● MiniFW-AI Demo — Government"
echo "  ─────────────────────────────────────────────────────"
echo "  Dashboard : https://localhost:8449"
echo "  Login     : admin / Government1!"
echo "  Sector    : Government / Sovereign Infrastructure"
echo ""
echo "  Ctrl+C to stop."
echo ""
