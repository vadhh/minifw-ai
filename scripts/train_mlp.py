...
def main():
    ...
    try:
        ...
        print(f"\nTo use this model:")
        print(f"  1. Copy to production: cp {args.output} /opt/minifw_ai/models/mlp_model.pkl")
        print(f"  2. Set environment: export MINIFW_MLP_MODEL=/opt/minifw_ai/models/mlp_model.pkl")
